...
- `PREDECESSOR: NIGHT-AAA-110 no dejó RESULTADO DEL TURNO ni matching handoff verificable al preflight JOBS CYCLE 115; SUPERSEDED / NOT_PASS.`
- `SERIALIZATION: AAA111 owns only F2/13.2. BBB110 owns F2/15.1. WOZ114 owns PR #93 integration review. PR #92 and #89 are parked/unassigned. No integration mutation.`
...
8. Un solo candidate/PR bounded si duplicate-check limpio; exact base/head + CI aplicable. **NO MERGE CYCLE 115.**
...
- `NIGHT-AAA-110`: `NO_RESULT / SUPERSEDED / NOT_PASS` en JOBS CYCLE 115.
