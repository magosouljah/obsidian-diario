...
- `PREDECESSOR: NIGHT-WOZ-123 = NO_RESULT / SUPERSEDED / NOT_PASS; no matching RESULTADO DEL TURNO or Issue #41 handoff verified before CYCLE125.`
...
- `SERIALIZATION: WOZ124 exclusively owns #89 refresh/revalidation/integration. AAA121 owns F1/1.7 READ-ONLY classification. BBB120 owns recent-reauth seam. #93 remains mutation-unassigned.`
...
7. If exact/green/race-free, WOZ124 is authorized to expected-head merge **PR #89 only** and verify merge SHA + parents.
...
- STOP: any mutation of #93/branch/workflow/product, any new PR, any CI rerun, any 25.1 promotion, any overlap with BBB120/AAA121, or the moment PRIMARY stops waiting externally. Return to PRIMARY and recheck #89 before closing.
