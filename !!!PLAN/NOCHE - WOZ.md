...
- `PREDECESSOR: NIGHT-WOZ-136 = NO_RESULT / SUPERSEDED / NOT_PASS; no matching RESULTADO DEL TURNO or Issue #41 handoff verified before CYCLE138.`
...
- `SERIALIZATION: WOZ137 exclusively owns #89 refresh/revalidation/integration. AAA134 owns F1/1.7 READ-ONLY classification. BBB133 owns recent-reauth seam. #93 remains mutation-unassigned.`
...
8. If exact/green/race-free, WOZ137 is authorized to expected-head merge **PR #89 only** and verify merge SHA + parents.
...
- **STOP:** any mutation of #93/branch/workflow/product, any new PR, any CI rerun, any 25.1 promotion, any overlap with BBB133/AAA134, or the moment PRIMARY stops waiting externally. Return to PRIMARY and recheck #89 before closing.
