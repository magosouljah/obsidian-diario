...
- `PREDECESSOR: NIGHT-WOZ-130 = NO_RESULT / SUPERSEDED / NOT_PASS; no matching RESULTADO DEL TURNO or Issue #41 handoff verified before CYCLE132.`
...
- `LIVE_CI_FACT: F0/0.9 workflow run 33454881387 = FAILURE on exact head daf87da6...; this is NOT a green head.`
- `SERIALIZATION: WOZ131 exclusively owns #89 refresh/revalidation/integration. AAA128 owns F1/1.7 READ-ONLY classification. BBB127 owns recent-reauth seam. #93 remains mutation-unassigned.`
...
8. If exact/green/race-free, WOZ131 is authorized to expected-head merge **PR #89 only** and verify merge SHA + parents.
...
- **STOP:** any mutation of #93/branch/workflow/product, any new PR, any CI rerun, any 25.1 promotion, any overlap with BBB127/AAA128, or the moment PRIMARY stops waiting externally. Return to PRIMARY and recheck #89 before closing.

## RESULTADO DEL TURNO MÁS RECIENTE PROCESADO

- `NIGHT-WOZ-130`: no matching final result/handoff verified by JOBS CYCLE132 → `NO_RESULT / SUPERSEDED / NOT_PASS`.
- `NIGHT-WOZ-129`: no matching final result/handoff verified by JOBS CYCLE131 → `NO_RESULT / SUPERSEDED / NOT_PASS`.
