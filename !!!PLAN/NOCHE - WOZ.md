...
- `PREDECESSOR: NIGHT-WOZ-140 = NO_RESULT / SUPERSEDED / NOT_PASS; no matching RESULTADO DEL TURNO or Issue #41 handoff verified before CYCLE142.`
...
- `SERIALIZATION: WOZ141 exclusively owns #89 refresh/revalidation/integration. AAA138 owns F2/12.1 runtime evidence READ-ONLY. BBB137 owns recent-reauth seam. #93 remains mutation-unassigned.`
...
8. If exact/green/race-free, WOZ141 is authorized to expected-head merge **PR #89 only** and verify merge SHA + parents.
...
- **STOP:** any mutation/rerun/review/merge/new PR/gate promotion, overlap with AAA138/BBB137, head movement during inspection, or PRIMARY no longer waiting. Return to #89 immediately when PRIMARY ceases waiting.
