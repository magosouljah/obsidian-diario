...
- **Evidencia 5.1 (en progreso):** PR #11 `security: define Task 5.1 trust boundaries`; head inicial `5cdcfcecccea63a31adc5eaf66416929c0fbb95a`; CI #103 PASS 6/6. Head documental corregido `bb162c01c80e21a264c4022c9c682a90c14fbb98`; CI #108 PASS 6/6 incluido `Required CI`. PR #12 `test(security): probe Telegram admin-rights churn`, head `2b8904880dfeaa57b970674a79abcb181161af0a`, CI #105 PASS 6/6; prueba riesgo de churn, no una cifra universal. PR #13 `test(security): prove M0 temp-auth binding boundary`, draft, head `96af35e85481ff85d856dc22949bfb314ebedc3e`; self-test aislado PASS; en CI #109 ya PASS Web/shared, Supply chain, Windows y macOS arm64, con macOS x86_64 aún en progreso. Los logs Web/shared ejecutan el nuevo vector y registran explícitamente `network_bind_proven=false` y `direct_mtproto_operation_proven=false`. Ningún checkbox 5.1 queda cerrado todavía.
