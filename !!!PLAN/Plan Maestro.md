...
10. **COORDINACIÓN MULTI-IA:** si el usuario asigna un rol `ATLAS`, `ARGOS`, `VIGÍA` o `RASTREADOR`, leer también `Equipo multi-IA - Roles y coordinación.md`. ATLAS debe consultar el **BeatGaler Issue #41 — AI Review Inbox** antes de continuar trabajo multi-IA y contrastar cualquier finding pendiente antes de modificar estado o gates.
...
- **Canal multi-IA:** BeatGaler Issue #41 `AI Review Inbox — handoff to ATLAS` es el buzón canónico para findings `BLOCKER/IMPORTANT/MINOR`. ATLAS los contrasta antes de cambiar estado; reviewers sin permisos de escritura producen `AI-HANDOFF`. El primer finding de VIGÍA fue la desincronización PR #39→#40 corregida en esta actualización.
...
3. Si se recibió un rol multi-IA, leer `Equipo multi-IA - Roles y coordinación.md`; ATLAS consulta además BeatGaler Issue #41 antes de continuar.
...
| `Equipo multi-IA - Roles y coordinación.md` | cuando el usuario asigna ATLAS/ARGOS/VIGÍA/RASTREADOR | responsabilidades, AI Review Inbox #41, handoffs y protocolo entre modelos |
