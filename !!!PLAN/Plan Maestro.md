...
- **Trabajo paralelo elegible:** Tarea 1.2 (dominio/DNS, Apple Developer, Authenticode, revisión legal/seguridad externa/hardware/testers) y reauditoría de Tarea 2.2 (historial Git/incidente). **Oleada vigente al crear ORION:** AAA tiene asignada la reauditoría de 2.2 y BBB la auditoría/actualización de 1.2; ORION hereda esas asignaciones, las verifica en Issue #41 y las reasigna cuando terminen. Las futuras asignaciones transitorias viven en Issue #41 para no llenar el Plan Maestro con estado efímero de cada oleada.
