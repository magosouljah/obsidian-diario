...
4. If and only if failure is attributable to transplanted harness/workflow/test plumbing, apply the minimum harness/workflow-only correction on #84. Preserve #74 product files/logic unchanged.
...
7. If evidence indicates #74 product corrective itself is insufficient, **STOP** and report the exact product finding to JOBS; do not modify #74 product logic under this assignment.
