...
**Baseline vivo CYCLE119:** `integration-v0.8.0-alpha.1 @ 43fdf70efe6d12f47f0cd08f6eaaf6440e32f1d3` al preflight JOBS.
...
Para una alpha 3–5 cuentas sin cobros, F1/1.7 debe clasificar explícitamente este gate como `RO_EXCLUDE_CANDIDATE` o `MUST_CLOSE`; no se infiere exclusión automáticamente. Owner de clasificación CYCLE119: `NIGHT-AAA-115` READ-ONLY. Release público sigue sujeto al gate completo.
...
Para alpha 3–5 cuentas, F1/1.7 debe clasificar explícitamente 20.2; no se fabrica como prerequisito representativo de una alpha pequeña ni se excluye sin decisión RO.

## Cross-phase security tail

PR #89 F0/0.9 contiene P1 DNS-rebinding SSRF corrective + audit AI-assisted. **Owner CYCLE119: `NIGHT-WOZ-118` bajo F0.** #89 sigue OPEN @ `daf87da6...`, recorded base `816f946c...`; GitHub ahora reporta `mergeable=true`, pero live integration `43fdf70e...` hace la base stale. Old-head green no sustituye refresh/exact-head. WOZ118 posee la única conditional integration lane sobre #89.
