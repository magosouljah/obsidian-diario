...
- No workaround/bypass autorizado. #83 queda `PARKED / TOOLING_BLOCKED` en CYCLE 094; no tiene owner de mutación mientras el path soportado no cambie materialmente.
...
**Regla CYCLE 094:** no repetir la misma Ready action, no usar GraphQL workaround/bypass y no asignar runtime-160 como si #83 ya estuviera integrado. Reabrir la transacción #83 solo cuando exista un cambio material verificable en la ruta soportada.
