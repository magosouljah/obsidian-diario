...
- Exact-head F3 20.2 Durable Waitlist run `33388377959` = SUCCESS; Desktop Portability/applicable Required CI family run `33388377963` = SUCCESS; D6 `33388377952` SUCCESS; D7 `33388377964` SUCCESS.
- NIGHT-WOZ-082 no cambió #83: quedó `BLOCKED_STOP` únicamente porque el anterior Draft→Ready falló por schema del connector.
- #76 legal/public routes permanece OPEN/stale/frozen.

## Owner CYCLE 084

**WOZ — `NIGHT-WOZ-083` — F3 / 20.2 / #83.**

PRIMARY: fresh exact recheck; retry Draft→Ready mediante la acción GitHub Ready-for-review actualmente disponible; si Ready queda verificado y base/head/scope/CI siguen exactos/race-free, expected-head merge + verificación inmediata del merge SHA/parents. WOZ/#83 es la única mutación de integración autorizada.

CI-FALLBACK: NONE. La prueba runtime 160 no debe ejecutarse contra un estado pre-#83 que podría quedar obsoleto inmediatamente.
...
- [ 🟡 ] durable waitlist #83 exact-head CI green but remains Draft/unmerged pending WOZ083 transaction.
