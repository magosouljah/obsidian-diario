...
- 19.1 infraestructura pública principal `PROVEN_OWNER_RUNTIME`; #87 security/status software integrated; external/provider/OAuth tails aplicables siguen parciales.
...
PR #89 F0/0.9 contiene P1 DNS-rebinding SSRF corrective + audit AI-assisted. **Owner CYCLE 109: `NIGHT-WOZ-108` bajo F0.** #89 sigue stale contra `1dbf60e...`; old-head green CI no sustituye refresh/exact-head. Si se integra, reduce riesgo software pero no sustituye provider/payment/capacity/legal evidence de F3.
