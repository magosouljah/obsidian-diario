...
- Siguiente subgate 5.1: **escalabilidad/admission control y comportamiento del pool bajo exclusividad preferida + shared-bot fallback**; después decidir explícitamente si expiración server-side/natural sigue siendo requisito, migración del runtime productivo sin credenciales compartidas y hardening restante.
