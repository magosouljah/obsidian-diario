...
- Siguiente subgate 5.1: **decidir explícitamente si expiración server-side/natural continúa como requisito**; después migración productiva sin credenciales compartidas y hardening restante.
