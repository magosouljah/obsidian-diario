...
- [ 🟡 ] Aprobar una persistencia transaccional durable con migrations, constraints, backup/restore y rollback como requisito de producción. **Arquitectura aprobada por RO el 25 de agosto de 2026; todo el mecanismo software de cutover/rollback y recuperación ya está integrado hasta PR #39. Falta ejecutar y evidenciar la infraestructura productiva real.**
