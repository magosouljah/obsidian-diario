...
- Siguiente subgate 5.1: validar la frontera temporal en **Windows/macOS/Web pura**; después probar delete propio/cross-bot, aislamiento cross-vault/shared-bot, escalabilidad/admission control, expiración server-side/natural si sigue requerida y la migración del runtime productivo sin credenciales compartidas.
